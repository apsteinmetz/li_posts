---
title: "Thoughts on Rates: a Chart Pack, Fall 2022 Pt. 3"
format: html
editor: visual
mainfont: Arial
execute: 
...
![Source: Atlanta Fed](data/implied_funds.jpg)

This seems overly optimistic to me. As a rule of thumb, two percent real rates in an environment of long-run inflation of, also, two percent is pretty reasonable. A four percent nominal cost of money, in other words. Alas, a gradual approach, leveling off at this new equilibrium, is unrealistic when inflation is running at nine percent. You've heard me talk about anchoring and hindsight bias before and it is vividly illustrated by market expectations now. We might get to a four percent funds rate but it will be on the way down from something higher.
...
Last time I said I'm waiting for an entry point to buy bonds or "add duration" as we like to say. The time to buy stocks will come later. Historically, the time to switch from bonds to stocks will come at the trough of the recession and THAT won't be until the Fed is well into their easing phase.
...
Since being put out to pasture I've been using my time to up my quant chops. I thought this would be a good opportunity to develop a machine learning model to trade bonds. I threw a lot of variables going back to 1977 into various ML models. My experiment was a failure. I could get a PREFECT fit on the training sample but only garbage out-of-sample. I am clearly "overfitting." I tried classifying rate moves as simply "up" or "down" with no improvement. I'm not ready to go to work for quant fund, it seems. Can you spot the moment in the chart below where we go "out-of-sample?"
...
Simply looking at the median return leaves a lot of information out. Were there crazy outliers? At the risk of information overload, lets look at the distribution of changes for each of the buckets above. Each "ridgeline" in the plot below represents the distribution of changes in one of the buckets in the heat map above.  Personally, I like the zero to minus 50 BP trigger for six months, indicated by the red arrow below. It had the fewest bad outcomes, though it's by no means foolproof.  So we'll call that "THE RULE."  Wish me luck.
