...
Problems: Data leakage. The inputs and outputs are highly serially correlated so the training set looks much like the test set even before stratifying.
...
summary_outcomes %>% 
  ...
  ggplot(aes(lead,slope_ranges,fill = median_change))  + geom_tile() + 
  theme_minimal() +
